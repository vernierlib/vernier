...
//    waitKey(10);
    ...
    UNIT_TEST(areEqual(patternPose.x, estimatedPose.x, 0.2));
    UNIT_TEST(areEqual(patternPose.y, estimatedPose.y, 0.2));
    UNIT_TEST(areEqual(patternPose.alpha, estimatedPose.alpha, 0.2));
}
